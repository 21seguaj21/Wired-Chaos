...
- **C++ Basics: Selection and Iteration** – Focused on conditional statements (if, else, switch) and loop constructs (for, while, do-while), which are essential for flow control.
- **An Introduction to Programming the Internet of Things (IoT)** – Provided experience with embedded systems and hardware interaction, reinforcing my understanding of how C++ integrates with microcontrollers.
- **C++ Basic Structures: Vectors, Pointers, Strings, and Files (In Progress)** – Covers advanced data handling and memory management. This aligns with the CPE requirement to demonstrate knowledge of managing dynamic memory safely and manipulating vectors and pointers [6].
...
- 30 questions across six sections: Variables & Data Types, Operators & Expressions, Control Flow, Arrays & Pointers, Functions & Scope, and Standard Library & Compilation.
- A mix of multiple-choice and fill-in-the-blank questions to simulate the actual exam experience provided by services like TestNow [8].

## Exam Outline and Study Plan
...
- **Syntax and Operators (28%)**: Understanding C++ syntax, literals, and input/output mechanisms.
- **Flow Control and Functions (28%)**: Utilizing functions and managing program logic.
- **Vectors and Pointers (24%)**: Managing dynamic memory safely.
- **Structures and Strings (20%)**: Organizing simple data within a program.
